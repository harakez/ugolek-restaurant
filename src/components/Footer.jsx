        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={themeStyle.text}>г. Ташкент, ул. Демонстрационная, 10</p>
            ...
            >
              ...
              <div className={`${themeStyle.cardBg} rounded-2xl p-6 border ${themeStyle.cardBorder} ${themeStyle.shadow}`}>
                <h3 className={`text-xl font-bold mb-3 ${themeStyle.accent}`}>Демо-Ресторан</h3>
                <p className={themeStyle.text}>г. Ташкент, ул. Демонстрационная, 10</p>
                <p className={`text-sm mt-2 ${themeStyle.secondary}`}>
                  Пример описания для демо-версии сайта ресторана
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className={`${themeStyle.secondary} text-sm`}>
              © 2025 Демо-версия сайта ресторана
            </p>
          </motion.div>
        </div>
      </footer>
